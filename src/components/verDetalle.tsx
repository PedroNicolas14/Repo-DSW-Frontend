        ...
        <div className="VerDetalle-overlay" onClick={closeVerDetalle}>
          <div className="VerDetalle-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="verDetalle-info">
              ...
              <p><strong>Nombre de la Marca:</strong> {selectedItem.marca.nombre}<img className="logo-marca" src={selectedItem.marca.logo} alt={selectedItem.marca.nombre}/></p>
              ...
              <button onClick={closeVerDetalle} className="verDetalle-close">Cerrar</button>
